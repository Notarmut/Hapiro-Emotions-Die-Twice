...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // Check for sprint input pressed this frame
            if (_input.sprint && !wasSprinting && Grounded)
            {
                StartDash();
            }
            wasSprinting = _input.sprint;
        ...
        private void StartDash()
        {
            ...
            // Calculate dash direction based on input and camera
            ...
            {
                // Convert input direction to camera space
            ...
            // Immediately face dash direction
        ...
        private void Move()
        {
            ...
            if (isDashing)
            {
                ...
                {
                    isDashing = false;
                    // If still holding sprint, continue with normal sprint
                    if (!_input.sprint)
                    {
            ...
            if (isDashing)
            {
                // Use pre-calculated dash direction
